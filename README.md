...
For the architecture, the findings behind it, and the measurements: [WHITEPAPER.html](docs/comfy-integration/WHITEPAPER.html) (build with [tools/Build-Whitepaper.ps1](tools/Build-Whitepaper.ps1)), or the diagrams alone in [docs/comfy-integration/diagrams/](docs/comfy-integration/diagrams/).
