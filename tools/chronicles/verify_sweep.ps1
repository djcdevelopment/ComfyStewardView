...
if (-not $SkipCreators) {
    "== creators"
    Check '/valheim/creators/' @('creators.css?v=14', 'id="stats-link"', 'href="/chronicles/"', 'src="./portraits.js"')
    Check '/valheim/creators/creators.css?v=14' @('--flame', '@font-face', '#portrait-picker')
    ...
    Check '/valheim/creators/kinship/' @('id="kin-tree"', '../creators.css?v=14', 'src="../portraits.js?v=14"', 'src="../kin-tree.js?v=14"', 'data-steward-page="kinship"', 'href="/chronicles/"') @('character', 'archetype', 'href="#participation-details"')
    ...
    Check '/valheim/creators/profile/' @('data-steward-page="profile"', '../creators.css?v=14', 'src="../creators.js?v=14"', 'src="../portraits.js?v=14"', 'src="../portrait-picker.js?v=14"', 'src="../profile.js"', 'id="profile-optout"', 'value="erase"', '@Tugcow', 'id="optout-message"', 'href="/chronicles/"') @('character', 'archetype', 'submitted', 'discord-client-id', 'href="#participation-details"')
    ...
    try {
        ...
        Check ('/valheim/creators/' + $top.builderKey + '/') @('../creators.css?v=14', 'src="../pair.js"', 'src="../kin-tree.js"', 'src="../portraits.js"', 'href="/chronicles/"', 'id="builder-hero"', '<a id="hero-avatar"', 'id="look-out"', 'id="thread-notes"')
