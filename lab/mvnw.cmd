...
set "SHARED_TOOLS=%SCRIPT_DIR%..\comfystewardview\.tools"
...
echo Maven is unavailable. Install Maven or keep this lab beside comfystewardview with its .tools directory.
exit /b 1
